...
const UpdateRoom = () => {
  useDocumentTitle('Booking | Update Room');
      ...
      .then(data => {
        if (data.modifiedCount) {
          Swal.fire({
            position: 'top-end',
            icon: 'success',
            title: 'Your Room updated successfully',
  ...
  return (
    <div className="max-w-5xl mx-auto p-5 bg-white dark:bg-gray-800 rounded-xl shadow-lg my-10 montserrat">
      <h2 className="text-3xl font-bold mb-3 text-center text-gray-800 dark:text-white font-serif">
        Update Your Room
      </h2>
      <h2 className="text-xl font-bold mb-6 text-center text-gray-800 dark:text-white font-serif">
        Make Luxury
      </h2>
